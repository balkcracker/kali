...
uint256 hashGenesisBlock("0x1cfd986d3f66d91bce4cd2c8d812d36a5ae122f08596d216b41cc79e3944e670");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(505094230); // kali: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "kali Signed Message:\n";
...
{
    // kali: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 10000 blocks, which will occur approximately every 3.5 days
    nSubsidy >>= (nHeight / 10000); // kali: 10k blocks in ~3.5 days

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 120; // kali: 3.5 days
static const int64 nTargetSpacing = 60; // kali: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // kali: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // kali: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // kali: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd1921e4bd9df3a7e79b36a5aa0225b9b2b836e436a08d8e5266b6e1615247626");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "kali1992";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("2bbe6e958d0bcd67a0b9a5ee3d0c2f14cf65f560289a15c87a258a8bee20d3cd225af24786c13b9ba5f97aab7f3edc2aae8d588db3175b2e2e0417a34bb2ffd5e3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1503009327;
        block.nBits    = 505094230;
        block.nNonce   = 2387552764;

        if (fTestNet)
        {
            block.nTime    = 1503009327;
            block.nNonce   = 3239772067;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc292019ec66d6bd9b2059de1981a248a6a346c8e8063858ddb531348ae66040c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // kali: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("kaliMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("kaliMiner : ProcessBlock, block not accepted");
    }
